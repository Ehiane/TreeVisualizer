...
const treeInfo: Record<string, {
  ...
  'b-tree': {
    title: 'B-Tree',
    description: 'A B-Tree is a self-balancing tree data structure that maintains sorted data and allows searches, sequential access, insertions, and deletions in logarithmic time. Unlike binary trees, B-Tree nodes can have more than two children.',
    howItWorks: [
      'Each node can contain multiple keys and children',
      'All leaves are at the same level',
      'Nodes are kept at least half full (except root)',
