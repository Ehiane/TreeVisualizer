...
export function BPlusTreePage() {
  ...
  const sidebarRef = useRef<{
    buildTree: () => void;
    clearTree: () => void;
    runTraversal: (type: 'inorder' | 'levelorder' | 'leaforder') => void;
  } | null>(null);
  ...
  const commands = [
    ...
    },
    {
      ...
      description: 'Execute in-order tree traversal',
    ...
    {
      id: 'leaf-order',
      label: 'Leaf-order Traversal',
      description: 'Execute leaf-order traversal (scan through linked leaf nodes)',
      action: () => sidebarRef.current?.runTraversal('leaforder'),
    },
    {
      id: 'clear',
      label: 'Clear Tree',
